...
contract DuzenlemeContract is Context, ERC20, Ownable, Stakeable {
    ...
    uint256 tokenDecimals = 1;
    uint256 tokenTotalSupply = 1 * 10**3 * 10**1;
    ...
    uint256 public minTokensBeforeSwap = 10000; 
    ...
    constructor (address _burnWallet, address _stakingWallet) ERC20(tokenName, tokenSymbol, tokenDecimals) {
    ...
    * @notice withdrawStake is used to withdraw stakes from the account holder
    ...
    function withdrawStake(uint256 index) public {
        (uint256 _amount , uint256 _reward) = calculateStakeAward(msg.sender, index, stakingPerReward);
        _withdrawStake(msg.sender, index, stakingTimeValue, stakingPerReward);
